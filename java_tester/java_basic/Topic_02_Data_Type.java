...
public class Topic_02_Data_Type {
 ...
 // Sự khác biệt giữa kiểu tham chiếu và nguyên thuỷ: 
    ...
    //nguyên thuỷ có giá trị của riêng nó trong bộ nhớ khi chạy, còn tham chiếu thì sẽ tham chiếu từ bộ nhớ stack sang lấy giá trị từ bộ nhớ heap (that's why gọi là tham chiếu)
