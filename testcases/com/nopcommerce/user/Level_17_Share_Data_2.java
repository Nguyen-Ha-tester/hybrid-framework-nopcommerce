...
public class Level_17_Share_Data_2 extends BaseTest {

	// login sử dụng register common class để load cookie đã được lưu
	...
	public void beforeClass(String browserName) {
		...
		log.info("Login - Step 02: Set cookie và reload page");
