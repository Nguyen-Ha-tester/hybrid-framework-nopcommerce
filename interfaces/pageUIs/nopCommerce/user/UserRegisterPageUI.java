...
public class UserRegisterPageUI {
	...
	public static final String FIRST_NAME_TEXT_FIELD = "id=FirstName";
	public static final String LAST_NAME_TEXT_FIELD = "id=LastName";
	public static final String EMAIL_TEXT_FIELD = "id=Email";
	public static final String PASSWORD_TEXT_FIELD = "id=Password";
	public static final String CONFIRM_PASSWORD_TEXT_FIELD = "id=ConfirmPassword";
	...
	public static final String EXISTING_EMAIL_ERROR_MESSAGE = "Css=div[class*='message-error']";
